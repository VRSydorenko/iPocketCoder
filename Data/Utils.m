...
+(NSString*)codeTemplateForLanguage:(int)langId{
    switch (langId) {
        ...
        case LANG_JAVASCRIPT_SPIDER: return TEMPL_JAVASCRIPT_SPIDER;
        case LANG_LUA: return TEMPL_LUA;
        case LANG_NEMERLE: return TEMPL_NEMERLE;
        case LANG_NICE: return TEMPL_NICE;
        case LANG_NIMROD: return TEMPL_NIMROD;
        case LANG_NODE_JS: return TEMPL_NODE_JS;
        case LANG_OBJ_C: return TEMPL_OBJ_C;
        case LANG_OCAML: return TEMPL_OCAML;
        case LANG_OCTAVE: return TEMPL_OCTAVE;
        case LANG_OZ: return TEMPL_OZ;
        case LANG_PARI_GP: return TEMPL_PARI_GP;
        ...
        case LANG_PYTHON: return TEMPL_PYTHON;
        case LANG_PYTHON3: return TEMPL_PYTHON3;
        case LANG_R: return TEMPL_R;
        case LANG_RUBY: return TEMPL_RUBY;
        case LANG_SCALA: return TEMPL_SCALA;
        case LANG_SCHEME: return TEMPL_SCHEME;
        case LANG_SMALLTALK: return TEMPL_SMALLTALK;
        case LANG_SQL: return TEMPL_SQL;
        case LANG_TCL: return TEMPL_TCL;
        case LANG_TEXT: return TEMPL_TEXT;
        case LANG_UNLAMBDA: return TEMPL_UNLAMBDA;
        case LANG_VB_NET: return TEMPL_VB_NET;
        case LANG_WHITESPACE: return TEMPL_WHITESPACE;
